        ...
        <div className="relative inline-block md:translate-y-20">
          <div className="general-title relative flex flex-col justify-center items-center gap-24">
            <div className="overflow-hidden place-self-start">
              <h1 className="nutrition-title">Sigue haciéndole</h1>
            </div>
            <div
              style={{
            ...
            >
              <div className="bg-yellow-brown pb-5 md:pt-0 pt-3 md:px-5 px-3">
                <h2 className="text-milk-yellow">Bien al Cuerpo</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex md:justify-center items-center translate-y-5">
          <div className="md:max-w-xs max-w-md">
            <p className="text-lg md:text-right text-balance font-paragraph">
              La leche contiene una amplia gama de nutrientes, incluyendo vitaminas, minerales y proteínas, y esta es sin lactosa.
            </p>
          </div>
        </div>
            ...
            {lists.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center">
                <div>
                  ...
                  <p className="font-paragraph text-sm mt-2">hasta</p>
