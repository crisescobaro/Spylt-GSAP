      ...
      <div className="hero-container">
        ...
        <div className="hero-content opacity-0">
          <div className="overflow-hidden">
            <h1 className="hero-title">Increíblemente Delicioso</h1>
          </div>
          <div
            style={{
          ...
          <h2>Vive la vida al máximo con SPYLT: rompe el aburrimiento y abraza a tu niño interior con cada trago deliciosamente suave.</h2>
